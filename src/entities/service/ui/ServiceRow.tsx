...
export function ServiceRow({ service }: ServiceRowProps) {
  return (
    <>
      ...
      <div className="border-t border-hair px-4 py-4 font-mono text-sm text-stone before:mr-1 before:text-stone before:content-['Prazo_·_'] min-[721px]:px-6 min-[721px]:before:content-none">
        {service.timeline}
      </div>
